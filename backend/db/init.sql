...
CREATE TABLE account_list (
  ...
  video_crawler_id INT DEFAULT NULL,
...
CREATE TABLE play_count_history (
    ...
    play_count_increase INT UNSIGNED DEFAULT NULL,
    likes_count_increase INT UNSIGNED DEFAULT NULL,
    comment_count_increase INT UNSIGNED DEFAULT NULL,
    save_count_increase INT UNSIGNED DEFAULT NULL,
    likes_count INT UNSIGNED DEFAULT NULL,
    play_count INT UNSIGNED DEFAULT NULL,
    comment_count INT UNSIGNED DEFAULT NULL,
    save_count INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS notifications (
  ...
  scheduled_at DATETIME DEFAULT NULL COMMENT 'JST保存（秒は0固定）',
  sent_at DATETIME DEFAULT NULL COMMENT 'JST保存（秒は0固定）',
